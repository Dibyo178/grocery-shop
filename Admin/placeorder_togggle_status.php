                            ...
                            while ($row = $select->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo '
                                    <tr class="' . $rowClass . '">
                                        ...
                                        <td>
                                            <button id="' . $row->id . '" class="btn btn-danger btndelete" role="button">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-check').click(function() {
            ...
            swal({
                title: "Do you want to update the order status?",
                text: "The order status will be updated.",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willUpdate) => {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == 'success') {
                                ...
                                if (row.hasClass('bg-red')) {
                                    row.removeClass('bg-red');
                                    button.html('<i class="fa-solid fa-check"></i> Mark as Checked');
                                } else {
                                    row.addClass('bg-red');
                                    button.html('<i class="fa-solid fa-circle"></i> Mark as Unchecked');
                                }
                            } else {
