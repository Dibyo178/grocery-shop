            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                while ($data = $select->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  $discount = $data['txtdiscountprice'];
                  $status = $data['status'];
                ?>
                <tr>
                  ...
                  <td><img src="FoodImages/<?php echo $image; ?>" width="100" height="70"></td>
                  <td><?php echo $status == 1 ? 'Available' : 'Not Available'; ?></td>
                  <td><a href="editproduct.php?editid=<?php echo $data['id']; ?>" class="btn btn-success">Edit</a></td>
                  <td><a href="?deleteid=<?php echo $data['id']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php
                  $index++;
                }
