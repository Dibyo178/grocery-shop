...
$delete_invoice_details->execute();    
    ...
    $update_invoice=$pdo->prepare("update tbl_invoice set customer_name=:cust,order_date=:orderdate,subtotal=:stotal,tax=:tax,discount=:disc,total=:total,paid=:paid,due=:due,payment_type=:ptype,subscription=:subs,mobile=:mobile,address=:address,barcode=:barcode  where invoice_id=$id");
   ...
   $update_invoice->bindParam(':barcode',$txt_barcode);     
        ...
        <input type="text" class="form-control pull-right" id="datepicker" name="orderdate" value="<?php echo $order_date;?>" >
                           ...
                           <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="txtbarcode" value="<?php echo $barcode;?>"placeholder="Enter Customer Barcode" 
