...
$update=$pdo->prepare("update addfood set image=:logo,name=:username,price=:password,role=:role  where id = $id");
...
swal({
  title: "Edit Food Offer Successfull!",
  text: "Added",
  icon: "success",
  button: "Ok",
});
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="txtselect_option" required>
                   <option value="" disabled selected>Select Role</option>
                    <option value="Branch1"<?php echo ($role_db=='Branch1')?'selected':''?>>Branch1</option>
                    <option value="Branch2"<?php echo ($role_db=='Branch2')?'selected':''?>>Branch2</option>
                    <option value="Branch3"<?php echo ($role_db=='Branch3')?'selected':''?>>Branch3</option>
