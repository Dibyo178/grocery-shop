...
//         $arr_total=$_POST['total'];
    ...
    $insert=$pdo->prepare("insert into tbl_invoice(customer_name,order_date,subtotal,discount,total,paid,due,payment_type,subscription,address,mobile,barcode) values(:cust,:orderdate,:stotal,:disc,:total,:paid,:due,:ptype,:subs,:address,:mobile,:barcode)");
