    ...
    if (in_array($f_extension, ['jpg', 'jpeg', 'png', 'gif'])) {
        if ($f_size >= 1000000) {
            ...
            if (move_uploaded_file($f_tmp, $store)) {
                ...
                if (!isset($error)) {
                    $insert = $pdo->prepare("INSERT INTO addfood(image, name, price) VALUES(:logo, :name, :price)");
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="txtname" class="form-control" id="exampleInputName" placeholder="Enter a product name" required>
                        </div>

                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" name='txtprice' class="form-control" id="exampleInputPrice" placeholder="Enter a price" required>
                        </div>
                    </div>
