...
$select=$pdo->prepare("select * from  tbl_token order by t_name asc"); 
$select->execute();
...
$output_customer.='<option value="'.$row["tid"].'">'.$row["t_name"].'</option>';   
...
//    $total=$_POST['total'];
  ...
  $insert=$pdo->prepare("insert into tbl_tokenproduct(pro_name,pro_mobile,pro_address,pro_date,	pro_des) values(:t_name,:t_mobile,:t_address,:t_date,:t_description)");
    ...
    $insert->execute();
      ...
      header('location:tokenProduction.php'); 
                  ...
                  <label >Description</label>
                   <textarea name="txtdescription" class="form-control" rows="4"></textarea>
                        ...
                        <div class="col-md-6">
                           ...
                           <label style="font-size:20px;color:green">Select  Existing Customer name From Grapics Room</label>
                            <div class="input-group">
<!--
                                <div class="input-group-addon">
                                    <i class="fa fa-user"></i>
        ...
        $(".localcustomerid").on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#txtlocalcustomername").val(result.t_name);





                    $("#txtlocalcmobile").val(result.t_mobile);


                    
                    $("#txtlocalcaddress").val(result.t_address);
