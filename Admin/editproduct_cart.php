...
$update=$pdo->prepare("update product_cart set image=:logo,name=:username,price=:password  where id = $id");
...
swal({
  title: "Edit Product Cart Successfull!",
  text: "Added",
  icon: "success",
  button: "Ok",
});
...
swal({
  title: "product_cart Update Successfuly",
  text: "Update",
  icon: "success",
  button: "Ok",
});
