...
$select=$pdo->prepare("select * from  tbl_tokenproduct order by pro_name asc"); 
$select->execute();
...
$output_customer.='<option value="'.$row["tpid"].'">'.$row["pro_name"].'</option>';   
...
//    $total=$_POST['total'];
  ...
  $insert=$pdo->prepare("insert into tbl_recepintiontoken(r_name,r_mobile,r_address,date,status) values(:t_name,:t_mobile,:t_address,:t_date,:status)");
    ...
    $insert->execute();
      ...
      header('location:tokenReception.php'); 
...
//         $arr_total=$_POST['total'];
    ...
    $insert=$pdo->prepare("insert into tbl_print(invoice_id,customer_name,date,discount,total,paid,due,payment,subscription,mobile,address) values(:invid,:cust,:orderdate,:disc,:total,:paid,:due,:ptype,:subs,:mobile,:address)");
        ...
        <input type="text" class="form-control pull-right" id="datepicker" name="orderdate" value="<?php echo date("Y-m-d");?>" data-date-format="yyyy-mm-dd" >
                           ...
                           <div class="form-group">
                                ...
                                <select name="txtstatus" id="txtstatus">
                                    ...
                                    <option name="txtstatus" value="None">None</option>
                                    <option name="txtstatus" value="Done">Done</option>
                                    <option name="txtstatus" value="Processing">Processing</option>
...
-->
                        ...
                        <div class="col-md-6">
                           ...
                           <label style="font-size:20px;color:green">Select  Existing Customer name From Production</label>
                            <div class="input-group">
<!--
                                <div class="input-group-addon">
                                    <i class="fa fa-user"></i>
        ...
        $(".localcustomerid").on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#txtlocalcustomername").val(result.pro_name);





                    $("#txtlocalcmobile").val(result.pro_mobile);


                    
                    $("#txtlocalcaddress").val(result.pro_address);
