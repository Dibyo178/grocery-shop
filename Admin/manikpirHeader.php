                    ...
                    <a href="./place_manikpir.php">
                     ...
                     while($row_message=mysqli_fetch_assoc($res_msg)){
                        ...
                        echo '
                            ...
                            <p> '.$index.' . <strong>'.$row_message["name"].'  </strong> One Place Order 
...
-->
      ...
      <li><a href="./place_manikpir.php"><i class="fa-solid fa-clipboard-list"></i><span> Place Order </span></a></li>
