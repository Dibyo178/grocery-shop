...
<body>
	...
	<section class="breadcrumb-area pt-100 pb-100" style="background-image:url('assets/discount-images/F.png');">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="breadcrumb-content">
						...
						<ul>
							<li><a href="index.html" style="color:darkgreen">Home</a></li>
							<li><i class="fas fa-angle-double-right" style="color:darkgreen"></i></li>
							<li style="color:darkgreen">About us</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 align-self-center">
					<div class="about-content">
						<h4>About Us</h4>
						<h2>Zaman Halal Food – A Halal Food Store in Japan</h2>
